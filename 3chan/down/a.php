...
<body>
    ...
    <h1>3chan</h1>
	<div id="banner">
		<img src="images/banner333.jpg" height="233" width="477">
	</div>
	<hr class="aboveTitle">
	<div id="boardTitle">
        <h2 id='headerText'>/a/ - Anime</h2>
	</div>
	<hr class="belowTitle">
	<?php
        
        $connection = mysqli_connect('localhost', 'louismel_admin', 'A1wmdMNddE', 'louismel_posts');
        $postsTable = "postsa";
		$page = "a.php";
